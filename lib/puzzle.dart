...
import 'package:quizlogopuzzle/Complete_lvl.dart';
import 'package:quizlogopuzzle/Data.dart';
import 'package:quizlogopuzzle/Grid_logo.dart';
import 'package:quizlogopuzzle/main.dart';
...
class _PuzzleState extends State<Puzzle> {
  ...
  Widget Wrong_ansDialog(){
    return AlertDialog(
      ...
      title: Text("Incorrect",style: TextStyle(fontSize: 35,color: Colors.white),),
      content: SizedBox(
        height: 300,
        width: 300,
        child: Column(
  ...
  void initState() {
    ...
    ans_keyword = List.filled(Data.answer[widget.index].toString().length * 2, "");
